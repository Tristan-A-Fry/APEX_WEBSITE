...
export default function DrillingDropdown() {
  return (
    <ul className="flex flex-col py-2 px-4 text-sm text-gray-800 ">
      <li>
        <Link to="/drillingcompletions" className="block py-2 px-3 !text-gray-600 bg-white dark:bg-[#2b2b2b] dark:!text-gray-300 hover:bg-red-100 hover:text-red-500 !font-bold rounded">
