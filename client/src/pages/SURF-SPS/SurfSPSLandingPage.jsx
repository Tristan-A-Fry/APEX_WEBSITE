      ...
      <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded shadow p-6 hover:shadow-lg transition">
          ...
          <div className="p-6">
            ...
            <Link to="/surf-execution" className="!text-red-700 !font-semibold hover:!underline">
              Learn more →
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded shadow p-6 hover:shadow-lg transition">
          ...
          <div className="p-6">
            ...
            <Link to="/systems-engineering" className="!text-red-700 !font-semibold hover:!underline">
              Learn more →
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded shadow p-6 hover:shadow-lg transition">
          ...
          <div className="p-6">
            ...
            <Link to="/skid-packaging" className="!text-red-700 !font-semibold hover:!underline">
              Learn more →
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded shadow p-6 hover:shadow-lg transition">
          ...
          <div className="p-6">
            ...
            <Link to="/controls-dcs" className="!text-red-700 !font-semibold hover:!underline">
              Learn more →
            </Link>
          </div>
        </div>
